...
getRouter()->addRoute('personNew',		'PersonEditCtrl',	['user','menager']);
getRouter()->addRoute('personEdit',		'PersonEditCtrl',	['user','menager']);
getRouter()->addRoute('personSave',		'PersonEditCtrl',	['user','menager']);
getRouter()->addRoute('personDelete',	'PersonEditCtrl',	['menager']);
